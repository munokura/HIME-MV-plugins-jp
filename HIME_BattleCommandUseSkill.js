 ...
 *
 * @plugindesc v1.3 コマンドメニューに直接スキルを使用できるメニューを追加します
 * @help
 * 翻訳:ムノクラ
...
@plugindesc v1.3 - Allows you to use a skill directly from the command menu rather than going to the skill menu.
@help 
== Description ==
