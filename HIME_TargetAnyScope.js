 ...
 * 
 * 元プラグイン:
 * https://himeworks.com/2020/08/target-any-scope
 * 
 * == 説明 ==
 * 
 * RPGツクールでは'味方1人分'や'敵全員分'といった
 * スキルやアイテムの範囲が用意されていますが、
 * '誰でも'や'全員'を対象にするという選択肢はありません。
 * 
 * このプラグインを利用することで、そのような機能が得られます。
 * 
 * == 使用方法 ==
 * 
 * アイテムやスキルに応じて2つのメモタグが用意されています。
 *  
 *    <scope: any one>
 *    <scope: any all>
 *    
 * 'any one'では、生きているアクターや敵を選択できます。
 * 'any all'は生きている全てのアクターと敵が効果対象になります。
 *
 * == 利用規約 ==
 * 
 * - クレジットを表示する非営利プロジェクトでの使用は無料
 * - 商用プロジェクトでの使用は無料ですが、
 *   お知らせくださったり、後援者になっていただければ幸いです。
